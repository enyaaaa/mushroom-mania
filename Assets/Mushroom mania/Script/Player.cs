...
namespace MushroomMania
{
    public class Player : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            {
                if (direction.sqrMagnitude < 0.0001f && new Vector3(myRigidBody.linearVelocity.x, 0f, myRigidBody.linearVelocity.z).sqrMagnitude < 4f)
                    myRigidBody.linearDamping = 100f;
                else if (direction.sqrMagnitude > 0.0001f)
                    myRigidBody.linearDamping = 2f;
                else myRigidBody.linearDamping = 8f; //v1.0: 6f
            }
            else if (!onGround)
            {
            ...
            {
                Vector3 rot = new Vector3(myRigidBody.linearVelocity.x, 0f, myRigidBody.linearVelocity.z);
            ...
            if (controlsEnabled)
            {
                ...
                float accel = Vector3.Dot(direction, new Vector3(myRigidBody.linearVelocity.x, 0f, myRigidBody.linearVelocity.z).normalized) * -12.5f * Time.fixedDeltaTime + (37.5f * Time.fixedDeltaTime);
                if (!onGround) accel *= 0.5f;

                //Speed cap
                Vector2 mvmntSpeed = new Vector2(myRigidBody.linearVelocity.x + direction.x * accel, myRigidBody.linearVelocity.z + direction.z * accel);
                ...
                if (hasDoubleJump && !onGround && jumpPress && !wallJump && hatPropeller != null)
                {
                    ...
                    Vector3 v = new Vector3(myRigidBody.linearVelocity.x, 0f, myRigidBody.linearVelocity.z);

                    hatPropeller.Rotate();
                    StartCoroutine(JumpAnim(1));
                    PlayRandomSound(voicePack.jumpVoiceSFX);
                    myRigidBody.linearVelocity = v + hatPropeller.propellerJumpVector;
                }
                ...
                else if (onGround && jumpPress)
                {
                    ...
                    if (isCrouch)
                    {
                        ...
                        if (i > 8f && GetInputDirection().sqrMagnitude > 0.25f)
                        {
                            ...
                            myRigidBody.linearVelocity = new Vector3(dirSpeed.x, 12f, dirSpeed.z);
                        }
                        ...
                        else
                        {
                            ...
                            myRigidBody.linearVelocity = v + Vector3.up * 18f - transform.forward * 5f;
                        }
                    ...
                    else
                    {
                        StartCoroutine(JumpAnim(1));
                        PlayRandomSound(voicePack.jumpVoiceSFX);
                        if (i > 64f) myRigidBody.linearVelocity = v + Vector3.up * 16f;
                        else myRigidBody.linearVelocity = v + Vector3.up * 15f;
                ...
                if (wallJump && jumpPress)
                {
                    ...
                    audioPlayer.PlayOneShot(jumpSFX);
                    PlayRandomSound(voicePack.jumpVoiceSFX);
                    myRigidBody.linearVelocity = Vector3.up * 16f - transform.forward * 9f;
            ...
            if (!myRigidBody.isKinematic)
                myRigidBody.linearVelocity = new Vector3(myRigidBody.linearVelocity.x, Mathf.Max(myRigidBody.linearVelocity.y - (gravity * Time.fixedDeltaTime), -24f), myRigidBody.linearVelocity.z);
            ...
            if (zAxisLock)
            {
                ...
                myRigidBody.linearVelocity = new Vector3(myRigidBody.linearVelocity.x, myRigidBody.linearVelocity.y, 0f);
            }
            ...
            prevVelocity = myRigidBody.linearVelocity;
        ...
        {
            Vector2 i = new Vector2(myRigidBody.linearVelocity.x, myRigidBody.linearVelocity.z);
            ...
            foreach (ContactPoint contact in collision.contacts)
            {
                ...
                if (Vector3.Dot(contact.normal, Vector3.up) > 0.6f)
                {
                    if (!onGround)
                    {
                        ...
                        forceVariableJump = false;
                        autoWallJump = false;
                        if (!disableFloorSnap && myRigidBody.linearVelocity.y <= 0f) myRigidBody.linearVelocity = new Vector3(prevVelocity.x, 0f, prevVelocity.z);
                    }
                    else
                    {
                ...
                else if (!groundPound && !hurtCooldown && Vector3.Dot(contact.normal, transform.forward) < -0.8f)
                {
                    ...
                    {
                        myRigidBody.linearVelocity = new Vector3(-contact.normal.x, myRigidBody.linearVelocity.y, -contact.normal.z);
                        wallJump = true;
                        wallCount = 8;
                        transform.rotation = Quaternion.Euler(0f, Quaternion.LookRotation(-contact.normal).eulerAngles.y, 0f);
                    }
                ...
                {
                    myRigidBody.linearVelocity = new Vector3(prevVelocity.x, 0f, prevVelocity.z);
                }
            }
        }
        ...
        public IEnumerator Pound()
        {
            ...
            poundCount = 4;
            myRigidBody.linearVelocity = Vector3.down * 24f;
        }
        ...
        public void BounceUp(float amount)
        {
            ...
            myRigidBody.linearDamping = 0f;
            myRigidBody.linearVelocity = new Vector3(myRigidBody.linearVelocity.x, amount, myRigidBody.linearVelocity.z);
        }
        ...
        public void Knockback(Vector3 knockback)
        {
            if (Vector3.Dot(knockback, Vector3.down) > 0.9f)
            {
                ...
                myRigidBody.linearDamping = 0f;
                transform.position += Vector3.up * 0.1f;
                myRigidBody.linearVelocity = new Vector3(myRigidBody.linearVelocity.x, 9f, myRigidBody.linearVelocity.z);
            }
            myRigidBody.linearVelocity += knockback * -9f;
        }
